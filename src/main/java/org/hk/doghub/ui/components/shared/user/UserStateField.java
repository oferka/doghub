...
public class UserStateField extends DogHubComboBoxField {
    ...
    public UserStateField() {
        super(LABEL, STATE_MAX_LENGTH, MAP_MARKER.create(), asList("Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana",
