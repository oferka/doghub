...
import static org.hk.doghub.model.tip.DogHubTip.MORE_INFO_MIN_LENGTH;
...
public class TipMoreInfoField extends EditableTextField {
    ...
    public TipMoreInfoField() {
        super(LABEL, false, MORE_INFO_MIN_LENGTH, MORE_INFO_MAX_LENGTH, INFO_CIRCLE.create(), null);
