...
public class UserTitleField extends DogHubComboBoxField {
    ...
    public UserTitleField() {
        super(LABEL, TITLE_MIN_LENGTH, TITLE_MAX_LENGTH, INFO_CIRCLE.create(), asList("Mr.", "Mrs.", "Ms.", "Miss", "Dr.", "Rev.", "Prof.", "Hon.", "Capt.", "Col.", "Lt.", "Sen.", "Rep.", "Gov.", "Pres.", "Sir", "Dame", "Lady", "Lord", "Knight", "Prince", "Princess"));
