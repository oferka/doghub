...
import static org.hk.doghub.DogHubApplication.APPLICATION_HIGH_RESOLUTION_LOGO_WHITE_ON_TRANSPARENT;
...
public class DogHubAppLayoutDrawerHeaderImage extends Image {
    ...
    public DogHubAppLayoutDrawerHeaderImage() {
        ...
        setSrc(APPLICATION_HIGH_RESOLUTION_LOGO_WHITE_ON_TRANSPARENT);
